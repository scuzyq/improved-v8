...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x,
                                    ...
                                    ResNetLayer, RTDETRDecoder, Segment, C2f_Att, C2f_DCN, C2f_DCN2, BiFPN_Concat2, BiFPN_Concat3, SPDConv, CSPOmniKernel, SBA, FeaturePyramidSharedConv, C2f_DeepDBB, ResBlock_CBAM, C2f_SHSA_CGLU, C2f_SHSA)
...
from ultralytics.nn.modules.CACSYOLO import CACS_C2f
...
from ultralytics.nn.modules.C2f_GhostModule_DynamicConv  import  *
...
from ultralytics.nn.modules.AdditiveBlock_CGLU import C2f_AdditiveBlock_CGLU
...
from ultralytics.nn.modules.LeYOLO  import  mn_conv, InvertedBottleneck,MobileNetV3_BLOCK
...
from ultralytics.nn.modules.CAS_ViT import C2f_AdditiveBlock


from ultralytics.nn.modules.vHeat import C2f_Heat
...
from ultralytics.nn.modules.DetectDeepDBB import DetectDeepDBB


from ultralytics.nn.modules.Detect_Partial_C import Detect_Partial_C
...
from ultralytics.nn.modules.HCANet import MSFN
...
from ultralytics.nn.modules.Detect_LSDECD import Detect_LSDECD
 
from ultralytics.nn.modules.Detect_LADH import Detect_LADH   
...
from ultralytics.nn.modules.MLLA import * 
...
from ultralytics.nn.modules.DualConv import *


from ultralytics.nn.modules.MLLABlock import * 
...
from ultralytics.nn.modules.Detect_DBB import Detect_DBB


from ultralytics.nn.modules.AFPNHead3 import Detect_AFPN3


from ultralytics.nn.modules.CLLAHead import CLLAHead

from ultralytics.nn.modules.FASFFHead import Detect_FASFF

from ultralytics.nn.modules.Detect_Adown import Detect_Adown

from ultralytics.nn.modules.DSConvHead import Detect_DySnakeConv
...
from ultralytics.nn.modules.MobileNetV3 import MobileNetV3
...
from ultralytics.nn.modules.att import SKAttention

from ultralytics.nn.modules.att import C2f_deformable_LKA

from ultralytics.nn.modules.conv import C2f_DySnakeConv

from ultralytics.nn.RepNCSPELAN4 import  *

from ultralytics.nn.RCSOSA  import  *
...
class BaseModel(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, (Detect, Detect_improve, Detect_AFPN, Detect_ASFF, Detect_FRM, ImplicitHead, AsDDet, LADH, Detect_DBB, Detect_AFPN3, CLLAHead, Detect_FASFF, Detect_Adown, Detect_DySnakeConv, Detect_LSDECD, Detect_LADH, Detect_dyhead3, Detect_improve_s, Detect_SC_C, Detect_Partial_C, DetectDeepDBB, RepHead, Segment)):
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg='yolov8n.yaml', ch=3, nc=None, verbose=True):  # model, input channels, number of classes
        ...
        # Build strides
        m = self.model[-1]  # Detect()
        if isinstance(m, (Detect, Detect_improve, Detect_AFPN, Detect_ASFF, Detect_FRM, AsDDet,  ImplicitHead, LADH, Detect_DBB, Detect_AFPN3, CLLAHead, Detect_FASFF, Detect_Adown, Detect_DySnakeConv, Detect_LSDECD, Detect_LADH, Detect_dyhead3, Detect_improve_s, Detect_SC_C, Detect_Partial_C, DetectDeepDBB, RepHead, Segment, Pose)):
            s = 256  # 2x min stride
...
def attempt_load_weights(weights, device=None, inplace=True, fuse=False):
    ...
    for m in ensemble.modules():
        t = type(m)
        if t in (nn.Hardswish, nn.LeakyReLU, nn.ReLU, nn.ReLU6, nn.SiLU, Detect, Detect_improve, Detect_AFPN, Detect_ASFF, Detect_FRM, AsDDet, ImplicitHead, LADH, Detect_DBB, Detect_AFPN3, CLLAHead, Detect_FASFF, Detect_Adown, Detect_DySnakeConv, Detect_LSDECD, Detect_LADH, Detect_dyhead3, Detect_improve_s, Detect_SC_C, Detect_Partial_C, DetectDeepDBB, RepHead, Segment):
            m.inplace = inplace
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    ch = [ch]
    layers, save, c2 = [], [], ch[-1]  # layers, savelist, ch 
    backbone=False
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, SPDConv, DWConv, Focus,
            ...
            c2 = ch[f[1]]
            args = [c2, *args]
        elif m in (Detect, Detect_improve, Detect_AFPN, Detect_ASFF, Detect_FRM, AsDDet, ImplicitHead, LADH, Detect_DBB, Detect_AFPN3, CLLAHead, Detect_FASFF, Detect_Adown, Detect_DySnakeConv, Detect_LSDECD, Detect_LADH, Detect_dyhead3, Detect_improve_s, Detect_SC_C, Detect_Partial_C, DetectDeepDBB, RepHead, Segment, Pose):
...
def guess_model_task(model):
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, (Detect, Detect_improve, Detect_AFPN, Detect_ASFF, Detect_FRM, AsDDet, ImplicitHead, LADH, Detect_DBB, Detect_AFPN3, CLLAHead, Detect_FASFF, Detect_Adown, Detect_DySnakeConv, Detect_LSDECD, Detect_LADH, Detect_dyhead3, Detect_improve_s, Detect_SC_C, Detect_Partial_C, DetectDeepDBB, RepHead)):
                return 'detect'
